...
use ConstructStudios\ReportToDiscord\PGTD;
...
use ConstructStudios\Report\listener\EventListener;
use ConstructStudios\Report\tasks\ReportRecieve;
use ConstructStudios\Report\tasks\ReportReset;
...
class Report extends PluginBase
{
    ...
    public function onEnable()
    {
        ...
        $this->getLogger()->info($this->prefix . "ReportSystem by ConstructStudios enabled!");
    }
